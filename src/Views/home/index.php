        ...
        <div class="mt-5">
            <?php if(isset($_SESSION['user_id'])): ?>
                <?php if($_SESSION['role_id'] == 1): ?>
                    <a href="/admin/dashboard" class="btn btn-lg px-5 py-3" style="background-color: #e14eca; color: white; font-weight: bold; border-radius: 30px;">Go to Admin Dashboard</a>
                <?php else: ?>
                    <a href="/hotel/dashboard" class="btn btn-lg px-5 py-3" style="background-color: #e14eca; color: white; font-weight: bold; border-radius: 30px;">Go to Hotel Dashboard</a>
                <?php endif; ?>
            <?php else: ?>
                <a href="/login" class="btn btn-lg px-5 py-3" style="background-color: #e14eca; color: white; font-weight: bold; border-radius: 30px;">Login to Portal</a>
            <?php endif; ?>
        </div>
    </div>
