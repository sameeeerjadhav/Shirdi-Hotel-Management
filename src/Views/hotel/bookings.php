<div class="page-header fade-in">
    <div>
        ...
        <p>Manage all upcoming and past reservations for your hotel.</p>
    </div>
</div>
...
<div class="card fade-in-2">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <button class="btn btn-outline-primary btn-sm"><i class="fa-solid fa-download me-1"></i> Export Data</button>
    </div>
        ...
        <table class="table mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="badge-pill" style="background:var(--primary-light);color:var(--primary);">Room <?= htmlspecialchars($booking['room']) ?></span></td>
                    <td>
